...
import com.venpoo.data_sdk.utils.IOUtils;
import com.venpoo.data_sdk.utils.JsonUtils;
...
public class HttpLoggingInterceptor implements Interceptor {
            ...
            if (logHeaders) {
                ...
                if (logBody && HttpHeaders.hasBody(clone)) {
                    ...
                    if (isPlaintext(responseBody.contentType())) {
                        ...
                        log("\nbody:" + JsonUtils.formatJson(body));
    ...
    private void bodyToString(Request request) {
        try {
            ...
            log("\nbody:" + JsonUtils.formatJson(buffer.readString(charset)));
        } catch (Exception e) {
            OkLogger.printStackTrace(e);
        }
    }
